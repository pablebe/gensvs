...
from eval_utils.utils import EmbeddingMSE, get_all_models, cache_embedding_files
...
def main():
    ...
    parser.add_argument('--test_dir', type=str, required=True, help='Path to processed audio directory')
    parser.add_argument('--target_dir', type=str, required=True, help='Path to target audio directory')
    parser.add_argument('--output_dir', type=str, required=True, help='Path to output directory for metric results')
